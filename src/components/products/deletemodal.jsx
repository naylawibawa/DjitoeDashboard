...
export default function ProductDeleteModal({ isOpen, product, onClose, onConfirm }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 font-inter">
      <div className="relative bg-white rounded-xl p-6 w-96 text-center shadow-lg">
        ...
        <h2 className="text-xl font-semibold text-indigo-400 mb-4">Delete Product</h2>
        <p className="text-gray-600 mb-6">
          This action cannot be undone. Do you want to delete this <b>{product.product}</b> product?
        </p>
