...
export default function JobDeleteModal({ isOpen, job, onClose, onConfirm }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 font-inter">
      <div className="relative bg-white rounded-xl p-6 w-96 text-center shadow-lg">
        ...
        <h2 className="text-xl font-semibold text-indigo-400 mb-4">Delete Job</h2>
        <p className="text-gray-600 mb-6">
          This action cannot be undone. Do you really want to delete this <b>{job.job}</b> position?
        </p>
